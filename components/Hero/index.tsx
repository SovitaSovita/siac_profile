          ...
          <div className="flex lg:items-center lg:gap-8 xl:gap-32.5">
            <div className=" md:w-1/2">
              <h4 className="mb-4.5 text-lg font-medium text-black dark:text-white">
                🔥 SIAC - The Securities Investors Association of Cambodia
              </h4>
              ...
              <p>
                Our vision...
                become the leading and largest association in training on securities trading, including digital assets.
              </p>
